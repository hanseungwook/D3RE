...
def main():
    ...
    mean_logdr_nnpu_15 = np.zeros((ite, epoch))
    ...
    mean_logdr_nnpu_20 = np.zeros((ite, epoch))
    ...
    mean_logdr_nnpu_50 = np.zeros((ite, epoch))
    ...
    mean_logdr_nnulsif_15 = np.zeros((ite, epoch))
    ...
    mean_logdr_nnulsif_20 = np.zeros((ite, epoch))
    ...
    mean_logdr_nnulsif_50 = np.zeros((ite, epoch))
    ...
    for i in range(ite):
        ...
        train_nnpu_15, test_nnpu_15, auc_nnpu_15, mean_nnpu_15, mean_lognnpu_15 = train(x_data, t_data, x_test, t_test, epoch, model_nnpu_15, optimizer_nnpu_15, device, batchsize=batchsize, method='nnPU', upper_bound=1.5)
        train_nnpu_20, test_nnpu_20, auc_nnpu_20, mean_nnpu_20, mean_lognnpu_20 = train(x_data, t_data, x_test, t_test, epoch, model_nnpu_20, optimizer_nnpu_20, device, batchsize=batchsize, method='nnPU', upper_bound=2)
        train_nnpu_50, test_nnpu_50, auc_nnpu_50, mean_nnpu_50, mean_lognnpu_50 = train(x_data, t_data, x_test, t_test, epoch, model_nnpu_50, optimizer_nnpu_50, device, batchsize=batchsize, method='nnPU', upper_bound=5)

        train_nnulsif_15, test_nnulsif_15, auc_nnulsif_15, mean_nnulsif_15, mean_lognnulsif_15 = train(x_data, t_data, x_test, t_test, epoch, model_nnulsif_15, optimizer_nnulsif_15, device, batchsize=batchsize, method='nnuLSIF', upper_bound=1.2)
        train_nnulsif_20, test_nnulsif_20, auc_nnulsif_20, mean_nnulsif_20, mean_lognnulsif_20 = train(x_data, t_data, x_test, t_test, epoch, model_nnulsif_20, optimizer_nnulsif_20, device, batchsize=batchsize, method='nnuLSIF', upper_bound=3)
        train_nnulsif_50, test_nnulsif_50, auc_nnulsif_50, mean_nnulsif_50, mean_lognnulsif_50 = train(x_data, t_data, x_test, t_test, epoch, model_nnulsif_50, optimizer_nnulsif_50, device, batchsize=batchsize, method='nnuLSIF', upper_bound=5)
        ...
        mean_logdr_nnpu_15[i] = mean_lognnpu_15
        ...
        mean_logdr_nnpu_20[i] = mean_lognnpu_20
        ...
        mean_logdr_nnpu_50[i] = mean_lognnpu_50
        ...
        mean_logdr_nnulsif_15[i] = mean_lognnulsif_15
        ...
        mean_logdr_nnulsif_20[i] = mean_lognnulsif_20
        ...
        np.savetxt('results/mean_logdr_nnpu_15_%s_%f.csv'%(dataset, learning_rate), mean_logdr_nnpu_15, delimiter=',')
        ...
        np.savetxt('results/mean_logdr_nnpu_30_%s_%f.csv'%(dataset, learning_rate), mean_logdr_nnpu_20, delimiter=',')
        ...
        np.savetxt('results/mean_logdr_nnpu_50_%s_%f.csv'%(dataset, learning_rate), mean_logdr_nnpu_50, delimiter=',')
        ...
        np.savetxt('results/mean_logdr_nnulsif_15_%s_%f.csv'%(dataset, learning_rate), mean_logdr_nnulsif_15, delimiter=',')
        ...
        np.savetxt('results/mean_logdr_nnulsif_30_%s_%f.csv'%(dataset, learning_rate), mean_logdr_nnulsif_20, delimiter=',')
        ...
        np.savetxt('results/mean_logdr_nnulsif_50_%s_%f.csv'%(dataset, learning_rate), mean_logdr_nnulsif_50, delimiter=',')
